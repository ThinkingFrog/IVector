...
[Интерфейс](https://github.com/ThinkingFrog/IVector/blob/main/include/ICompact.h) для n-мерного параллелепипеда - компакта в n-мерном евклидовом пространстве.

Фактически представляет собой сетку, которая заданна двумя векторами, содержащими информацию о границах параллелепипеда, и массивом числа разбиений на узлы.
...
- метод `derivativeByArgs` вычисляет частную производную по аргументам (определяется по мульти-индексу).
