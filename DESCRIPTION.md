...
|Параметры: | `dim` - размерность вектора, <br />`ptr_data` - указатель на массив double, которые определяют элементы вектора. Его размер равен `dim`. |
...
| Параметры: | `dim` - количество элементов массива, <br />`ptr_data` - указатель на массив double, которые определяют элементы вектора. |
