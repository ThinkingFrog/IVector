...
### Замечания по реализации:
- Деструктор чисто виртуальный намеренно, аналогично `IVector`.
- Метод `getBroker` явно не объявлен в [заголовочном файле](https://github.com/ThinkingFrog/IVector/blob/main/include/IBroker.h), так как отсутствует необходимость в объявлении. Метод также необходимо для бинарной совместимости компилировать как обычную си функцию (см. [`extern "C"`](https://docs.microsoft.com/en-us/cpp/cpp/extern-cpp?view=msvc-160#extern-c-and-extern-c-function-declarations)).
