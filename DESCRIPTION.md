...
| Возвращаемое значение: | `true`, если итератор ссылается на вектор в множестве, <br />`false`, если итератор ссылается на удалённый вектор. В случае ошибки также возвращается `false`. <br />Подробная информация пишется в логгер. |
