...
| Возвращаемое значение: | Итератор или `nullptr`, если произошла ошибка. <br />Подробная информация пишется в логгер. |
...
- В множестве хранится массив уникальных индексов, которые присваиваются векторам при добавлении. Индексы уникальны, поэтому повторяться не могут.
- Общение итератора и множества происходит через контрольный блок.
